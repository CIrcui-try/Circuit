...
가장 중요. AGENTS.md "expand-contract 방식" 규칙 위반을 잡는다.
...
변경 라인이 있으면 표시. AGENTS.md 의 2026-04-22~04-27 인시던트 재발 방지 — env vars 가 누락되면 컨테이너가 ephemeral SQLite 로 폴백.
