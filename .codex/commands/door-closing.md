---
description: 2단계 — develop fetch + 워크트리 생성 + 구현 계획(plan.md) 작성
...
8. **상태 파일 갱신**: `worktree_path`, `plan_path` 채우고 `stages.door_closing.done_at = <UTC ISO8601>`.
9. **요약 출력**: 워크트리 경로, 변경 파일 수, 구현 단계 수를 한두 문장으로 안내.
